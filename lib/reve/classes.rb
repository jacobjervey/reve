...
module Reve #:nodoc:
  module Classes #:nodoc:
    ...
    class CharacterInfo
      ...
      attr_reader :security_status, :skillpoints, :skill_training_ends, :ship_name, :ship_type_id, :ship_type_name, :last_known_location, :account_balance
      ...
      def initialize(elem) #:nodoc:
        ...
        @alliance_date = (elem/'allianceDate').inner_html == "" ? nil : Time.parse((elem/'allianceDate').inner_html)
